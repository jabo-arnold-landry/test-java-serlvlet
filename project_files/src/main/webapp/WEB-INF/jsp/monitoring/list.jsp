        ...
        <body>
            ...
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 style="font-weight:700;margin:0;">System Monitoring Logs</h4>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="${pageContext.request.contextPath}/monitoring/report" class="btn btn-outline-info"><i
                                class="bi bi-bar-chart"></i> View Report</a>
                        <a href="${pageContext.request.contextPath}/monitoring/new" class="btn btn-primary"><i
                                class="bi bi-plus-lg"></i> Record Manual Reading</a>
                    </div>
                </div>
                    ...
                    <table class="table hover">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${log.equipmentType == 'COOLING'}">
                                            ...
                                            <c:if test="${log.supplyAirTemp != null}"> | Supply: ${log.supplyAirTemp}°C
                                            </c:if>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="${pageContext.request.contextPath}/monitoring/view/${log.logId}"
                                                class="btn btn-outline-info" title="View"><i class="bi bi-eye"></i></a>
                                            <a href="${pageContext.request.contextPath}/monitoring/edit/${log.logId}"
                                                class="btn btn-outline-warning" title="Edit"><i
                                                    class="bi bi-pencil"></i></a>
                                            <button type="button" class="btn btn-outline-danger" title="Delete"
                                                onclick="confirmDelete('${pageContext.request.contextPath}/monitoring/delete/${log.logId}')"><i
                            ...
                            <c:if test="${empty readings}">
                                <tr>
                                    <td colspan="6" class="text-center text-muted">No monitoring logs recorded yet.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
