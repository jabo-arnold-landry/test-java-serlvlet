...
<head>
    <meta charset="UTF-8">
    <title>SPCMS - Equipment Health Report</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="row g-4">
            <div class="col-md-3"><div class="stat-card"><h6>Total Incidents</h6><h3>${report.totalIncidents}</h3></div></div>
            <div class="col-md-3"><div class="stat-card"><h6>Critical Incidents</h6><h3 class="text-danger">${report.criticalIncidents}</h3></div></div>
            <div class="col-md-3"><div class="stat-card"><h6>Resolved Incidents</h6><h3 class="text-success">${report.resolvedIncidents}</h3></div></div>
            <div class="col-md-3"><div class="stat-card"><h6>Avg Downtime</h6><h3>${report.avgDowntimeMinutes} min</h3></div></div>
        </div>
