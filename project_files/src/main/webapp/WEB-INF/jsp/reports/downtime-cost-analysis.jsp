...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="${pageContext.request.contextPath}/reports/cost-analysis/export-downtime-cost-pdf?branch=${selectedBranch}&start=${startDate}&end=${endDate}" class="btn btn-danger btn-sm me-2" title="Download as PDF">
