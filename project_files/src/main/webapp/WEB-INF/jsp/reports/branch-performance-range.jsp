        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <c:if test="${not empty reports}">
                    <a href="${pageContext.request.contextPath}/reports/branch-performance/export-range-pdf?branch=${selectedBranch}&start=${startDate}&end=${endDate}" class="btn btn-danger">
