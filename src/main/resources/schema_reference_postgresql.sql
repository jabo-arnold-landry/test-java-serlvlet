...
CREATE TABLE IF NOT EXISTS ups (
    ...
    phase               VARCHAR(50) DEFAULT 'SINGLE_PHASE',
...
CREATE TABLE IF NOT EXISTS ups_battery (
    ...
    battery_health_status   VARCHAR(50) DEFAULT 'GOOD',
...
CREATE TABLE IF NOT EXISTS cooling_unit (
    cooling_id          BIGSERIAL PRIMARY KEY,
    asset_tag           VARCHAR(50) UNIQUE NOT NULL,
    ...
    cooling_mode        VARCHAR(50) DEFAULT 'AUTO',
    fan_speed           VARCHAR(50),
    compressor_status   VARCHAR(50) DEFAULT 'STOPPED',
    ...
    filter_status       VARCHAR(50) DEFAULT 'CLEAN',
    drain_status        VARCHAR(50) DEFAULT 'CLEAR',
