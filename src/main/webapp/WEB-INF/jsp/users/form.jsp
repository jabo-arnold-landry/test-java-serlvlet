...
<head>
    ...
    <title>SPCMS - ${user.userId != null ? 'Edit' : 'Create'} User</title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 style="font-weight:700;margin:0;">${user.userId != null ? 'Edit' : 'Create New'} User</h4>
                <p class="text-muted mb-0" style="font-size:14px;">Configure user account with role-based access</p>
            </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4 d-flex align-items-center mt-4">
                        <div class="form-check form-switch">
                            <!-- If user is new, default to checked. Otherwise rely on user.isActive -->
                            ...
                            <label class="form-check-label ms-2" for="isActiveSwitch">Account Active</label>
                        </div>
                    </div>
                </div>
