...
<head>
    <meta charset="UTF-8">
    <title>SPCMS - Quarterly Report</title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div><h4 style="font-weight:700;margin:0;">Quarterly Consolidated Report</h4></div>
        </div>

        <div class="card mb-4">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/reports/quarterly" method="get" class="row g-3 align-items-center">
                    <div class="col-auto">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="alert alert-info">
                    <i class="bi bi-info-circle"></i> No report data found for this quarter.
                </div>
            </c:otherwise>
        </c:choose>
    </div>
